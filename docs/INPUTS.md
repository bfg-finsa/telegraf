...
- Input Plugins must be added to the
  `github.com/bfg-finsa/telegraf/plugins/inputs/all/all.go` file.
...
[exec]: https://github.com/bfg-finsa/telegraf/tree/master/plugins/inputs/exec
[amqp_consumer]: https://github.com/bfg-finsa/telegraf/tree/master/plugins/inputs/amqp_consumer
[prom metric types]: https://prometheus.io/docs/concepts/metric_types/
[input data formats]: https://github.com/bfg-finsa/telegraf/blob/master/docs/DATA_FORMATS_INPUT.md
